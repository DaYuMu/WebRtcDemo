...
public class WebRTCRoomManager implements ISignalingEvents {
    ...
    public static WebRTCRoomManager getInstance() {
        return WebRTCRoomManager.Holder.wrManager;
    }

    private static class Holder {
        private static WebRTCRoomManager wrManager = new WebRTCRoomManager();
    }
    ...
    public void onJoinToRoom(ArrayList<String> connections, String myId) {
        ...
        Log.e("JoinToRoom：", connections.toString() + "==myId==" + myId);
